...
return [
    'ctrl' => [
        'title' => $_LLL . ':tx_cartbooks_domain_model_specialprice',
        'label' => 'price',
        ...
        '1' => [
            'showitem' => '
                ...
                --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_tca.xlf:pages.tabs.access,
                    --palette--;LLL:EXT:cart_books/Resources/Private/Language/locallang_tca.xlf:palettes.visibility;hiddenonly,
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_cartbooks_domain_model_specialprice.pid=###CURRENT_PID### AND tx_cartbooks_domain_model_specialprice.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'title' => [
            'exclude' => 1,
            'label' => $_LLL . ':tx_cartbooks_domain_model_specialprice.title',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim',
        ...
        'price' => [
            'exclude' => 1,
            'label' => $_LLL . ':tx_cartbooks_domain_model_specialprice.price',
            'config' => [
                'type' => 'input',
                'size' => 30,
        ...
        'frontend_user_group' => [
            'exclude' => 1,
            'label' => $_LLL . ':tx_cartbooks_domain_model_specialprice.frontend_user_group',
            'config' => [
                'type' => 'select',
                'readOnly' => 0,
